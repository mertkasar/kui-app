...
import com.mertkasar.kui.fragments.CourseFragment.OnListFragmentInteractionListener;
...
public class CourseRecyclerViewAdapter extends RecyclerView.Adapter<CourseRecyclerViewAdapter.ViewHolder> {
    ...
    public CourseRecyclerViewAdapter(List<DataSnapshot> dataSet, OnListFragmentInteractionListener listener) {
        mDataSet = dataSet;
        mListener = listener;
    }
        ...
        holder.mView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (null != mListener) {
                    ...
                    mListener.onListFragmentInteraction(holder.mKey);
                }
            }
        });
    }
